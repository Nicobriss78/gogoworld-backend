...
const TRILL_REASON = {
  ...
  EVENT_NOT_PROMOTABLE: "EVENT_NOT_PROMOTABLE",
  ...
  TRILL_RESOURCE_NOT_AVAILABLE: "TRILL_RESOURCE_NOT_AVAILABLE",
  TRILL_RESOURCE_CONSUME_FAILED: "TRILL_RESOURCE_CONSUME_FAILED",
...
async function getEventForTrill(eventId) {
  return Event.findById(eventId)
    .select(
      "title organizer approvalStatus visibility isPrivate dateStart dateEnd participants revokedUsers location lat lon"
    )    .lean();
}
